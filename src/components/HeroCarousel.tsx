...
const slides = [
  {
    ...
    subtitle: "Your trusted marketplace for game top-ups and digital products",
  },
  {
    id: 2,
    image: savingsBanner,
...
export const HeroCarousel = () => {
  ...
  return (
    <div
      className="relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden rounded-xl"
